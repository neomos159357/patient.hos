			...
			<div class="row">
				...
				<div class="tabbable" id="tabs-683685"><div class="jumbotron">
						...
						<p align="left">Staff</p>
                                <form method ="post" action = "doctor_info.php" name="doctor_form">
                            			<tr>
                                		<p align="center"><input type="submit" name="doctor" value="Doctor"/></p>
                            			</tr>
										</form>                                     
                                <form method ="post" action = "nurse_info.php" name="nurse_form">
                            			<tr>										
                                		<p align="center"><input type="submit" name="nurse" value="Nurse"/></p>																
									    </tr>  
										</form>      
								<form method ="post" action = "finance_info.php" name="finance_form">
                            			<tr>										
                                		<p align="center"><input type="submit" name="finance" value="Finance"/></p>																
									    </tr>                  				
                                        </form>         
								<form method ="post" action = "executive_info.php" name="execuive_form">
                            			<tr>										
                                		<p align="center"><input type="submit" name="executive" value="Executive"/></p>																
									    </tr>                  				
                                        </form>                     
							</div>
						</div>

			...
			<div class="row">
				...
				<div class="jumbotron">
						<ul class="nav nav-tabs">
                            ...
                            <li class="nav-item">
								<a class="nav-link active show" href="contact.php"" data-toggle="tab">Contact</a>
							</li>
						...
						<div class="jumbotron">								                   			
                                		...
                                		<td><p align="left"> CMU Hostpital </p></td>                           										
                                		<td><p align="left"> xxx xxx xxx </p></td>
										<td><p align="left"> Chiang Mai 50200 </p></td>	
                                        <td><p align="left"> Phone : xxx-xxxxxxx </p></td>									
									    </tr>                               
							</div>

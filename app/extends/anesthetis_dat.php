	...
	<div class="row">
		<div class="col-md-12">
			...
			<div class="row">
				...
				<div class="col-md-5">
                <div class="tabbable" id="tabs-683685">
				<div class="jumbotron">
						<ul class="nav nav-tabs">
                            ...
                            <li class="nav-item">
                                ...
                                <p align="left">Staff > Docter > Anesthetist </p>
								<form method ="post" action = "#" name="Anesthetist_form">
                        			                      				
                                        <?php
                                        $sql = "select * from staff ";
                                        $sql.="WHERE Type LIKE '%Anesthetist'";
                                        ...
                                        <img src="https://sv1.picz.in.th/images/2018/11/08/3Z7LWI.png" alt="3Z7LWI.png" border="0" width = 100px height = 100px/>
                                        <tr><p align="center"><td>Name : <?= $rs->Name; ?></td></p></tr>

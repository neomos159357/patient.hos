		...
		<div class="col-md-12">
			...
			<div class="row">
                ...
                <div class="tabbable" id="tabs-683685"><div class="jumbotron">
						...
						<p align="left">Staff > Executive </p>	
								<form method ="post" action = "#" name="Executive_form">
                        			                      				
                                        <?php
                                        $sql = "select * from staff ";
                                        $sql.="WHERE Type LIKE '%Executive'";
                                        ...
                                        <img src="https://sv1.picz.in.th/images/2018/11/08/3ZS04E.png" alt="3Z7LWI.png" border="0" width = 100px height = 100px/>

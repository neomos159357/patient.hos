			...
			<div class="row">
				...
				<div class="col-md-5">
					<div class="tabbable" id="tabs-683685"><div class="jumbotron">
						...
						<p align="left">Staff > Finance</p>		
								<form method ="post" action = "#" name="finance_form">
                        			                      				
                                        <?php
                                        $sql = "select * from staff WHERE Type LIKE '%Finance'";
                                        ...
                                        <img src="https://sv1.picz.in.th/images/2018/11/08/3Z7I3l.png" alt="3Z7LWI.png" border="0" width = 100px height = 100px/>

		...
		<div class="col-md-12">
			...
			<div class="row">
                ...
                <div class="tabbable" id="tabs-683685"><div class="jumbotron">
						...
						<p align="left">Staff > Nurse</p>
								<form method ="post" action = "#" name="nurse_form">
                        			                      				
                                        <?php
                                        $sql = "select * from staff ";
                                        $sql.="WHERE Type LIKE '%Nurse'";
										...
										<img src="https://sv1.picz.in.th/images/2018/11/08/3Z7oO1.png" alt="3Z7oO1.png" border="0" width = 100px height = 100px/>
